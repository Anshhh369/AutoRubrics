...
def select_option():
 ...
 # Maintain index based on previous selections if they exist
    option_1 = st.selectbox(
        "Detail Level of Criteria",
        options_1,
        index=options_1.index(st.session_state.selected_option[0]) if len(st.session_state.selected_option) > 0 else None
    )
    ...
    option_2 = st.selectbox(
        "Grading Strictness",
        options_2,
        index=options_2.index(st.session_state.selected_option[1]) if len(st.session_state.selected_option) > 1 else None
    )
    ...
    option_3 = st.selectbox(
        "Area of Emphasis in Grading",
        options_3,
        index=options_3.index(st.session_state.selected_option[2]) if len(st.session_state.selected_option) > 2 else None
    )
    ...
    option_4 = st.selectbox(
        "Assignment Type",
        options_4,
        index=options_4.index(st.session_state.selected_option[3]) if len(st.session_state.selected_option) > 3 else None
    )
    ...
    option_5 = st.selectbox(
        "Assignment Style",
        options_5,
        index=options_5.index(st.session_state.selected_option[4]) if len(st.session_state.selected_option) > 4 else None
    )
